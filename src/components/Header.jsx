...
import igniteLogo from '../assets/IgniteLogo_new.png'
  ...
  return (
    <nav className="w-4/5 flex md:justify-center justify-between items-center py-4 mx-auto">
      <div className="flex flex-row justify-start items-center md:flex-[0.5] flex-initial">
        <img className="w-20 cursor-pointer" src={igniteLogo} alt="Adulam Logo" />
        <span className="text-white text-2xl ml-2 font-bold">Ignite</span>
      </div>
